...
public class BookingService {
	...
	@Autowired
	private VariantService vsrv;
	@Autowired
	private BikeService bksrv;
	@Autowired
	...
	{ 
		throw new IllegalArgumentException("Payment amount must be greater than zero."); 
		  ...
		  pmt.setAmount(dto.getAmount()); pmt.setBooking(bk);
		  pmt.getAmount();
		  pmt.setNameoncard(dto.getNameoncard()); pmt.setCardno(dto.getCardno());
		  pmt.setRemarks("Payment completed"); pmt.setIscompleted(true);
		  prepo.save(pmt);
...
/*
 * Stock entity=new Stock(); BeanUtils.copyProperties(dto, entity); return
 * entity;
 */